...
require (
	...
	github.com/gobuffalo/genny v0.0.0-20180809192233-bfbb144ab2de // indirect
	...
	github.com/markbates/willie v1.0.4
	...
	golang.org/x/tools v0.0.0-20180810201625-27709f6afec4 // indirect
